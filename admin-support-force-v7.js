...
(function () {
  ...
  /* Critical fix: the old 690px messenger could push the composer below the
     viewport. Fit the Admin chat card to the actual remaining viewport space. */
  ...
  function css(){
    ...
    s.textContent='#support .messenger{display:grid!important;grid-template-columns:330px minmax(0,1fr)!important;min-height:330px!important;overflow:hidden!important}#support .conversation{display:grid!important;grid-template-rows:auto minmax(0,1fr) auto!important;height:100%!important;min-height:0!important;overflow:hidden!important;position:relative!important}#support #chatHeader{grid-row:1!important;min-height:70px!important}#support #supportMessages{grid-row:2!important;min-height:0!important;height:auto!important;overflow-y:auto!important;overflow-x:hidden!important}#support #replyForm{grid-row:3!important;display:flex!important;visibility:visible!important;opacity:1!important;position:relative!important;inset:auto!important;width:100%!important;min-height:70px!important;height:auto!important;z-index:100000!important;align-items:center!important;gap:8px!important;padding:10px 12px!important;margin:0!important;background:var(--panel,#fff)!important;border-top:1px solid var(--line,#e5eaf2)!important;box-sizing:border-box!important}#support #replyForm.hidden{display:flex!important}#support #replyForm #replyInput{display:block!important;visibility:visible!important;opacity:1!important;flex:1 1 auto!important;width:auto!important;min-width:0!important;height:44px!important;min-height:44px!important;max-height:140px!important;box-sizing:border-box!important;resize:none!important}#support #replyForm .send-btn{display:inline-flex!important;visibility:visible!important;opacity:1!important;flex:0 0 44px!important;width:44px!important;height:44px!important;align-items:center!important;justify-content:center!important}#support #replyForm .composer-tool{display:inline-flex!important;visibility:visible!important;opacity:1!important;flex:0 0 auto!important}#support .thread{width:100%;display:flex;align-items:center;gap:10px;text-align:left;border:0;background:transparent;cursor:pointer}#support .thread.active{background:rgba(88,72,220,.09);border-radius:14px}#support .thread .thread-main{min-width:0;flex:1}#support .thread .thread-main small{display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}#support .admin-v8-empty{padding:28px;text-align:center;color:#7b8496}#support .admin-v8-row{display:flex;margin:8px 0}#support .admin-v8-row.user{justify-content:flex-start}#support .admin-v8-row.admin,#support .admin-v8-row.bot{justify-content:flex-end}#support .admin-v8-bubble{max-width:min(760px,82%);padding:10px 13px;border-radius:16px;box-shadow:0 4px 14px rgba(20,30,60,.06);line-height:1.45;word-break:break-word}#support .admin-v8-row.user .admin-v8-bubble{background:#fff;border:1px solid #e5eaf2}#support .admin-v8-row.admin .admin-v8-bubble{background:#e9e6ff;color:#252060}#support .admin-v8-row.bot .admin-v8-bubble{background:#f1efff;color:#342d72}#support .admin-v8-bubble small{display:block;margin-top:4px;opacity:.62;font-size:11px}@media(max-width:650px){#support #replyForm .composer-tool{display:none!important}}
';
