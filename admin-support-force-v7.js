/* ADMIN SUPPORT V7 — ROOT ASSET
   This file intentionally lives at the repository root so /admin/* rewrite rules
   cannot turn the JavaScript request into admin/index.html.
*/
(function(){
  'use strict';
  ...
  function state(){return window.admin||null}
