...
export async function merSolve({message,subject,history,image}){
  ...
  const primary='Bạn là chuyên gia giải bài của STUDY TH. Giải độc lập từ đề gốc. '+
    'Với toán, hãy nêu dữ kiện, mục tiêu, phương pháp, các bước suy luận và kết luận. '+
  ...
  const review='Bạn là chuyên gia kiểm định và hoàn thiện lời giải STUDY TH. '+
    'Đọc đề gốc và lời giải nháp dưới đây. Tự kiểm tra từng bước, sửa sai nếu có và xuất ra MỘT lời giải cuối cùng hoàn chỉnh. '+
