...
export function reportAiSuccessAsync(prefix,id){void reportAiSuccess(prefix,id).catch(()=>{});}
export function reportAiFailureAsync(prefix,id,error){void reportAiFailure(prefix,id,error).catch(()=>{});}
