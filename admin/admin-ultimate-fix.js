...
(function(){
  if(window.__studyAdminUltimateFixV3)return;window.__studyAdminUltimateFixV3=true;
  function loadCss(path){if(document.querySelector('link[data-admin-v3="'+path+'"]'))return;var l=document.createElement('link');l.rel='stylesheet';l.href='/admin/'+path+'?v=20260810-3';l.dataset.adminV3=path;document.head.appendChild(l)}
  function loadJs(path){return new Promise(function(resolve){if(document.querySelector('script[data-admin-v3="'+path+'"]'))return resolve();var s=document.createElement('script');s.src='/admin/'+path+'?v=20260810-3';s.dataset.adminV3=path;s.onload=resolve;s.onerror=function(){console.error('Admin final asset failed:',path);resolve()};document.body.appendChild(s)})}
  ...
  function boot(){loadCss('admin-chat-final.css');loadJs('admin-chat-final.js').then(ensureComposer);ensureComposer()}
  ...
  setInterval(function(){ensureComposer()},700);
})();
